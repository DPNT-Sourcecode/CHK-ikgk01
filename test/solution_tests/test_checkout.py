...
class TestCheckout(unittest.TestCase):
    ...
    def test_add(self):
        ...
        self.assertEqual(CheckoutSolution().checkout("K"), 70, "Not correct!")
        self.assertEqual(CheckoutSolution().checkout("KK"), 120, "Not correct!")
        ...
        self.assertEqual(CheckoutSolution().checkout("S"), 20, "Not correct!")
        ...
        self.assertEqual(CheckoutSolution().checkout("X"), 17, "Not correct!")
        self.assertEqual(CheckoutSolution().checkout("Y"), 20, "Not correct!")
        self.assertEqual(CheckoutSolution().checkout("Z"), 21, "Not correct!")
        self.assertEqual(CheckoutSolution().checkout("STXYZZ"), 90, "Not correct!")
        self.assertEqual(CheckoutSolution().checkout("STXYZ"), 82, "Not correct!")
